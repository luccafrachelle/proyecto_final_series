...
- Incluye tres outliers, de modo que cumple la proporción deseable de una proporción de intervenciones menor al 5%.
...
Modelo$regarima$arma
Modelo$regarima$arima.coefficients
Modelo$regarima$regression.coefficients
Modelo$regarima$loglik
```
