...
A efectos de evaluar el cumplimiento del supuesto de Homocedasticidad o Varianza Constante, se planteó la FAC y FACP del cuadrado de los residuos así como el contraste de Ljung-Box. En el primero se observa la significación de los coeficientes de autocorrelación y autocorrelación parcial de orden 6, lo que sugiere el incumplimiento del supuesto. 
...
El MAE (Mean Absolute Error o Error Absoluto Medio) presenta un error en términos absolutos que, para ambos casos, en comparación con el rango de valores de la serie, no parece ser tan alto. El MAPE (Mean Absolute Percentage Error o Error Medio Absoluto Porcentual), el cual muestra dichos errores en términos relativos, muestra que el modelo comete en promedio un 0,44% de error relativo respecto al valor real para el caso del set de entrenamiento y un 0,66% para el caso de los tres meses de 2025.
