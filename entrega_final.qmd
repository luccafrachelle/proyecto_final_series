...
En este caso corresponde observar la FAC y FACP en los múltiplos de $12$. Se observa la significación tanto del primer coeficiente de autocorrelación como de autocorrelación parcial, lo que sugiere la utilización de $(P = 1, D = 1, Q = 0)[12]$ o $(P = 0, D = 1, Q = 1)[12]$ para la parte estacional de un primer modelo $\text{SARIMA}$.
...
Donde $Y_t$ denota a la serie de datos original, $L$ al operador de retardos y $\epsilon_t$ un ruido blanco. ${\phi}_2$ y ${\Phi}_1$ son los coeficientes respectivas de las partes AR del componenente Regular y Estacional del Modelo.
...
```{r}
load("Componentes/Salidas_Script_Componentes.Rdata")
